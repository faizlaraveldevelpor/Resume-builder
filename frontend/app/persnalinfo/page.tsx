  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="p-8 md:px-16 2xl:w-[1200px] w-full bg-gradient-to-r  from-[#f9fbff] via-[#ffffff] to-[#f1f5ff] rounded-2xl shadow-sm mt-5 border border-gray-100">
        ...
        {/* Image + Upload */}
        <div className="mt-6 flex items-center flex-wrap  gap-x-6 bg-[#F7F9FC] rounded-xl px-6 py-4 shadow-sm border border-gray-100">
          ...
          <Button className="bg-[#1C74F8] hover:bg-[#0e64e6] cursor-pointer md:mt-0 mt-3 text-white font-medium px-5" onClick={()=>{
              if (imgRef.current) {
